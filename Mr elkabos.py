...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Gr}Ex [+967xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh} {Gr}Mr Dark elkabos -YEMEN-   {Wh}
       : o    `.        {Wh}       {Gr}  @Mr_Dark_elkabos      {Wh}
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
